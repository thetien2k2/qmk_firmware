...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_S1] = LAYOUT_ortho_5x15( /* FUNCTION */
    ...
    KC_MUTE, KC_VOLD, KC_VOLU, KC_MRWD, KC_MPLY, KC_MFFD,   KC_BTN4, KC_BTN3, KC_BTN5,        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,               KC_BTN1, KC_MS_U, KC_BTN2,        KC_WH_U, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
    CG_TOGG, KC_NO, AG_TOGG, KC_NO, KC_NO, KC_NO,           KC_MS_L, KC_MS_D, KC_MS_R,        KC_WH_D, KC_WH_L, _______, KC_WH_R, KC_NO, KC_NO
  )
};
