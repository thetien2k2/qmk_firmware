...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT_ortho_5x15( /* QWERTY */
    ...
    KC_CAPS, KC_A, KC_S, KC_D, KC_F, KC_G,                  KC_HOME, KC_DEL, KC_END,       KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_ENT,
    KC_LSPO, KC_Z, KC_X, KC_C, KC_V, KC_B,                  KC_PGDOWN, KC_UP, KC_PGUP,        KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSPC,
  ...
  [_S0] = LAYOUT_ortho_5x15( /* FUNCTION */
    ...
    KC_MRWD, KC_MPLY, KC_MFFD, KC_NO, KC_NO, KC_NO,         KC_BTN1, KC_PSCR, KC_BTN2,      KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,               KC_WH_L, KC_MS_U, KC_WH_R,  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
    KC_NO, KC_NO, KC_NO, _______, KC_NO, KC_NO,             KC_MS_L, KC_MS_D, KC_MS_R,   KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
  ),
